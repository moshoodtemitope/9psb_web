...
import "../styles.scss"; 
class ConfirmBankTransfer extends React.Component{
    constructor(props) {
        super(props);
    ...
    let confirmBeneficiaryRequest = this.props.confirmBeneficiaryReducer.request_data.customerData;
                            ...
                            <Formik
                                ...
                                onSubmit={(values, { resetForm }) => {
                                    ...
                                    let payload = {
                                        ...
                                        otherInfo:{ 
                                            displayName: confirmBeneficiaryRequest.displayName,
    ...
    render() {
        ...
        return (
            <Fragment>
                <Helmet>
                    <title>9PSB - Transfer to bank account | confirm</title>
                </Helmet>
                <InAppContainer>
...
export default connect(mapStateToProps)(ConfirmBankTransfer);