...
import "../styles.scss"; 
class PassChangeSuccess extends React.Component{
    constructor(props) {
        super(props);
        let getExistingInfo = this.props.ChangePasswordReducer;
        this.state={
            
            existingCustomerInfo: (Object.keys(getExistingInfo).length >= 1
                        && getExistingInfo.request_status === onboardingConstants.CHANGE_PASSWORD_SUCCESS)
                ...
                <div className="twosided nomargin">
                    <div>
                        <div className="page-section-mainheading app-panel">
                            ...
                            <h3 class="centered">Successful</h3>
                        </div>
    ...
    render() {
        ...
        return (
            <Fragment>
                <Helmet>
                <title>9PSB - Change Password success</title>
                </Helmet>
                <InAppContainer>
...
export default connect(mapStateToProps)(PassChangeSuccess);